...
var gameData = { "question-one":
			{"question": "Which?", "choices" : ["Help", "Try", "Word", "Film"], 
			"correct": "Film", "image": 'url("assets/images/color.png")' }, 
				"question-two":
			{"question": "Which number is correct?", "choices" : [2, 6, 9, 12], 
			"correct": 2}, 
				"question-three":
			{"question": "Pick number 11 already", "choices" : [3, 4, 11, 1],
			 "correct": 11}, 
				"question-four":
			{"question": "Pick one of these four words", "choices" :["This", "That", "How", "When"], 
			"correct": "How"},
				"question-five":
				{"question": "New Question", "choices": ["One", "Two", "Three", "Four"], 
				"correct": "Four"}, 
				//!<--end of question section of gameData object
		"gameMechanics" : {timerCount: function() {
		time = 15;
